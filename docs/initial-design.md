AITools is a package registry system allowing for:
...
- support an aitools.json and aitools-lock.json

the system will be composed of 2 major components.
- cli tool (like npm but for ai-tools) allows for project level and user level configuration. aitools.config.json. should cascade like npm does with .npmrc
