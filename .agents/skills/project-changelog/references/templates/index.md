...
<!-- One paragraph. What is this system? Stack, runtime, primary purpose. -->

*Replace this with a single paragraph describing the system.*
...
<!-- Last 3-5 significant entries across all files, most recent first. -->
<!-- Keeps the AI oriented without loading every section. -->
...
<!--
Last SHA: 0000000
Run `git log 0000000..HEAD --oneline` to see commits since last changelog update.
Update this SHA every time a new entry is added.
-->
