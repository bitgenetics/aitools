...
import type { ToolManifest, RegistryConfig, GitRegistryConfig, HttpRegistryConfig } from '@bitgenetics/aitools-core';
import { isGitRegistryConfig } from '@bitgenetics/aitools-core';
